 ...
 */
function generateNullifierHash(externalNullifier, identityNullifier) {
...
function genSignalHash(signal) {
    return BigInt(solidity.keccak256(["bytes32"], [strings.formatBytes32String(signal)])) >> BigInt(8);
}

function generateProof(identity, group, externalNullifier, signal, snarkArtifacts) {
    return __awaiter(this, void 0, void 0, function () {
        var commitment, index, merkleProof, _a, proof, publicSignals;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    commitment = identity.generateCommitment();
                    index = group.indexOf(commitment);
                    if (index === -1) {
                        throw new Error("The identity is not part of the group");
                    }
                    merkleProof = group.generateProofOfMembership(index);
                    return [4 /*yield*/, snarkjs.groth16.fullProve({
 ...
 */
function verifyProof(verificationKey, _a) {
    var proof = _a.proof, publicSignals = _a.publicSignals;
    return snarkjs.groth16.verify(verificationKey, [
...
exports.generateNullifierHash = generateNullifierHash;
exports.generateProof = generateProof;
exports.generateSignalHash = genSignalHash;
